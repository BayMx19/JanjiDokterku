...
const form = useForm({
    user_id: props.dokter.user_id || "",
    NIK: props.dokter.NIK || "",
    jenis_kelamin: props.dokter.jenis_kelamin || "",
    spesialisasi: props.dokter.spesialisasi || "",
    jadwal:
        props.dokter.jadwal && props.dokter.jadwal.length > 0
            ? props.dokter.jadwal
